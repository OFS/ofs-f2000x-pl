...
set_clock_groups -asynchronous -group {sys_pll|iopll_0_clk_sys}  -group {*|gen_ptile.u_ptile|intel_pcie_ptile_ast_qhip|inst|inst|maib_and_tile|xcvr_hip_native|rx_ch15}
set_clock_groups -asynchronous -group {host_pcie|avmm_clock0}    -group {*|gen_ptile.u_ptile|intel_pcie_ptile_ast_qhip|inst|inst|maib_and_tile|xcvr_hip_native|rx_ch15}
set_clock_groups -asynchronous -group {soc_pcie|avmm_clock0}     -group {*|gen_ptile.u_ptile|intel_pcie_ptile_ast_qhip|inst|inst|maib_and_tile|xcvr_hip_native|rx_ch15}
set_clock_groups -asynchronous -group {sys_pll|iopll_0_clk_100m} -group {*|gen_ptile.u_ptile|intel_pcie_ptile_ast_qhip|inst|inst|maib_and_tile|xcvr_hip_native|rx_ch15}
