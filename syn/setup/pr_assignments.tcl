...
if { [info exist env(OFS_BUILD_TAG_FLAT) ] } { 
    ...
    #####################################################
    set_instance_assignment -name PARTITION green_region               -to soc_afu|pg_afu.port_gasket|pr_slot|afu_main
    set_instance_assignment -name CORE_ONLY_PLACE_REGION            ON -to soc_afu|pg_afu.port_gasket|pr_slot|afu_main
    set_instance_assignment -name RESERVE_PLACE_REGION              ON -to soc_afu|pg_afu.port_gasket|pr_slot|afu_main
    set_instance_assignment -name PARTIAL_RECONFIGURATION_PARTITION ON -to soc_afu|pg_afu.port_gasket|pr_slot|afu_main
    set_instance_assignment -name PLACE_REGION $AFU_PLACE_REGION       -to soc_afu|pg_afu.port_gasket|pr_slot|afu_main
    set_instance_assignment -name ROUTE_REGION $AFU_ROUTE_REGION       -to soc_afu|pg_afu.port_gasket|pr_slot|afu_main

    ## Top I/O row memory
    set_instance_assignment -name CORE_ONLY_PLACE_REGION ON       -to mem_ss_top|mem_ss_fm_inst|mem_ss_fm|intf_0
    set_instance_assignment -name PLACE_REGION $TOP_MEM_REGION    -to mem_ss_top|mem_ss_fm_inst|mem_ss_fm|intf_0

    set_instance_assignment -name CORE_ONLY_PLACE_REGION ON       -to mem_ss_top|mem_ss_fm_inst|mem_ss_fm|msa_0
    set_instance_assignment -name PLACE_REGION $TOP_MEM_REGION    -to mem_ss_top|mem_ss_fm_inst|mem_ss_fm|msa_0

    set_instance_assignment -name CORE_ONLY_PLACE_REGION ON       -to mem_ss_top|mem_ss_fm_inst|mem_ss_fm|intf_1
    set_instance_assignment -name PLACE_REGION $TOP_MEM_REGION    -to mem_ss_top|mem_ss_fm_inst|mem_ss_fm|intf_1

    set_instance_assignment -name CORE_ONLY_PLACE_REGION ON       -to mem_ss_top|mem_ss_fm_inst|mem_ss_fm|msa_1
    set_instance_assignment -name PLACE_REGION $TOP_MEM_REGION    -to mem_ss_top|mem_ss_fm_inst|mem_ss_fm|msa_1
    ...
    set_instance_assignment -name PLACE_REGION $BOTTOM_MEM_REGION -to mem_ss_top|mem_ss_fm_inst|mem_ss_fm|intf_2

    set_instance_assignment -name CORE_ONLY_PLACE_REGION ON       -to mem_ss_top|mem_ss_fm_inst|mem_ss_fm|msa_2
    set_instance_assignment -name PLACE_REGION $BOTTOM_MEM_REGION -to mem_ss_top|mem_ss_fm_inst|mem_ss_fm|msa_2
