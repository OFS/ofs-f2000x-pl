...
# SOC
set_global_assignment -name IP_FILE   ../ip_lib/src/pd_qsys/fabric/ip/soc_apf/soc_apf_clock_bridge.ip
set_global_assignment -name IP_FILE   ../ip_lib/src/pd_qsys/fabric/ip/soc_apf/soc_apf_reset_bridge.ip
set_global_assignment -name IP_FILE   ../ip_lib/src/pd_qsys/fabric/ip/soc_apf/soc_apf_st2mm_mst.ip
set_global_assignment -name IP_FILE   ../ip_lib/src/pd_qsys/fabric/ip/soc_apf/soc_apf_bpf_mst.ip
set_global_assignment -name IP_FILE   ../ip_lib/src/pd_qsys/fabric/ip/soc_apf/soc_apf_default_slv.ip
set_global_assignment -name IP_FILE   ../ip_lib/src/pd_qsys/fabric/ip/soc_apf/soc_apf_bpf_slv.ip
set_global_assignment -name IP_FILE   ../ip_lib/src/pd_qsys/fabric/ip/soc_apf/soc_apf_st2mm_slv.ip
set_global_assignment -name IP_FILE   ../ip_lib/src/pd_qsys/fabric/ip/soc_apf/soc_apf_pr_slv.ip
set_global_assignment -name IP_FILE   ../ip_lib/src/pd_qsys/fabric/ip/soc_apf/soc_apf_achk_slv.ip
set_global_assignment -name QSYS_FILE ../ip_lib/src/pd_qsys/fabric/soc_apf.qsys
...
set_global_assignment -name IP_FILE   ../ip_lib/src/pd_qsys/fabric/ip/bpf/bpf_host_apf_mst.ip
...
set_global_assignment -name IP_FILE ../ip_lib/src/pd_qsys/fabric/ip/bpf/bpf_soc_apf_slv.ip
set_global_assignment -name IP_FILE ../ip_lib/src/pd_qsys/fabric/ip/bpf/bpf_soc_pcie_slv.ip
...
set_global_assignment -name IP_FILE ../ip_lib/src/pd_qsys/fabric/ip/bpf/bpf_host_apf_slv.ip
