...
package require -exact qsys 18.0
	...
	set_interface_property rst_n EXPORT_OF bpf_reset_bridge.in_reset
        ...
        add_component bpf_soc_apf_slv ip/bpf/bpf_soc_apf_slv.ip axi4lite_shim bpf_soc_apf_slv 1.0
        load_component bpf_soc_apf_slv
        set_component_parameter_value AW {21}
        set_component_parameter_value DW {64}
        set_component_project_property HIDE_FROM_IP_CATALOG {false}
        save_component
        load_instantiation bpf_soc_apf_slv
        remove_instantiation_interfaces_and_ports
        add_instantiation_interface clock clock INPUT
        set_instantiation_interface_parameter_value clock clockRate {0}
        set_instantiation_interface_parameter_value clock externallyDriven {false}
        ...
        add_component bpf_soc_pcie_slv ip/bpf/bpf_soc_pcie_slv.ip axi4lite_shim bpf_soc_pcie_slv 1.0
        load_component bpf_soc_pcie_slv
        set_component_parameter_value AW {12}
        set_component_parameter_value DW {64}
        set_component_project_property HIDE_FROM_IP_CATALOG {false}
        save_component
        load_instantiation bpf_soc_pcie_slv
        remove_instantiation_interfaces_and_ports
        add_instantiation_interface clock clock INPUT
        set_instantiation_interface_parameter_value clock clockRate {0}
        set_instantiation_interface_parameter_value clock externallyDriven {false}
        ...
        add_component bpf_host_apf_slv ip/bpf/bpf_host_apf_slv.ip axi4lite_shim bpf_host_apf_slv 1.0
        load_component bpf_host_apf_slv
        set_component_parameter_value AW {21}
        set_component_parameter_value DW {64}
        set_component_project_property HIDE_FROM_IP_CATALOG {false}
        save_component
        load_instantiation bpf_host_apf_slv
        remove_instantiation_interfaces_and_ports
        add_instantiation_interface clock clock INPUT
        set_instantiation_interface_parameter_value clock clockRate {0}
        set_instantiation_interface_parameter_value clock externallyDriven {false}
        ...
        add_component bpf_host_apf_mst ip/bpf/bpf_host_apf_mst.ip axi4lite_shim bpf_host_apf_mst 1.0
        load_component bpf_host_apf_mst
        set_component_parameter_value AW {21}
        set_component_parameter_value DW {64}
        set_component_project_property HIDE_FROM_IP_CATALOG {false}
        save_component
        load_instantiation bpf_host_apf_mst
        remove_instantiation_interfaces_and_ports
        add_instantiation_interface clock clock INPUT
        set_instantiation_interface_parameter_value clock clockRate {0}
        set_instantiation_interface_parameter_value clock externallyDriven {false}
        ...
        set_component_parameter_value AW {22}
        set_component_parameter_value DW {64}
        set_component_project_property HIDE_FROM_IP_CATALOG {false}
        save_component
        ...
        set_instantiation_interface_parameter_value altera_axi4lite_slave readDataReorderingDepth {1}
        set_instantiation_interface_parameter_value altera_axi4lite_slave trustzoneAware {true}
        add_instantiation_interface_port altera_axi4lite_slave s_awaddr awaddr 22 STD_LOGIC_VECTOR Input
        add_instantiation_interface_port altera_axi4lite_slave s_awprot awprot 3 STD_LOGIC_VECTOR Input
        add_instantiation_interface_port altera_axi4lite_slave s_awvalid awvalid 1 STD_LOGIC Input
        add_instantiation_interface_port altera_axi4lite_slave s_awready awready 1 STD_LOGIC Output
        add_instantiation_interface_port altera_axi4lite_slave s_wdata wdata 64 STD_LOGIC_VECTOR Input
        ...
        add_instantiation_interface_port altera_axi4lite_slave s_bvalid bvalid 1 STD_LOGIC Output
        add_instantiation_interface_port altera_axi4lite_slave s_bready bready 1 STD_LOGIC Input
        add_instantiation_interface_port altera_axi4lite_slave s_araddr araddr 22 STD_LOGIC_VECTOR Input
        add_instantiation_interface_port altera_axi4lite_slave s_arprot arprot 3 STD_LOGIC_VECTOR Input
        add_instantiation_interface_port altera_axi4lite_slave s_arvalid arvalid 1 STD_LOGIC Input
        add_instantiation_interface_port altera_axi4lite_slave s_arready arready 1 STD_LOGIC Output
        add_instantiation_interface_port altera_axi4lite_slave s_rdata rdata 64 STD_LOGIC_VECTOR Output
        ...
        set_instantiation_interface_parameter_value altera_axi4lite_master trustzoneAware {true}
        set_instantiation_interface_parameter_value altera_axi4lite_master writeIssuingCapability {16/4}
        add_instantiation_interface_port altera_axi4lite_master m_awaddr awaddr 22 STD_LOGIC_VECTOR Output
        add_instantiation_interface_port altera_axi4lite_master m_awprot awprot 3 STD_LOGIC_VECTOR Output
        add_instantiation_interface_port altera_axi4lite_master m_awvalid awvalid 1 STD_LOGIC Output
        add_instantiation_interface_port altera_axi4lite_master m_awready awready 1 STD_LOGIC Input
        add_instantiation_interface_port altera_axi4lite_master m_wdata wdata 64 STD_LOGIC_VECTOR Output
        ...
        add_instantiation_interface_port altera_axi4lite_master m_bvalid bvalid 1 STD_LOGIC Input
        add_instantiation_interface_port altera_axi4lite_master m_bready bready 1 STD_LOGIC Output
        add_instantiation_interface_port altera_axi4lite_master m_araddr araddr 22 STD_LOGIC_VECTOR Output
        add_instantiation_interface_port altera_axi4lite_master m_arprot arprot 3 STD_LOGIC_VECTOR Output
        add_instantiation_interface_port altera_axi4lite_master m_arvalid arvalid 1 STD_LOGIC Output
        add_instantiation_interface_port altera_axi4lite_master m_arready arready 1 STD_LOGIC Input
        add_instantiation_interface_port altera_axi4lite_master m_rdata rdata 64 STD_LOGIC_VECTOR Input
        ...
        add_connection bpf_clock_bridge.out_clk/bpf_soc_apf_slv.clock
        set_connection_parameter_value bpf_clock_bridge.out_clk/bpf_soc_apf_slv.clock clockDomainSysInfo {-1}
        set_connection_parameter_value bpf_clock_bridge.out_clk/bpf_soc_apf_slv.clock clockRateSysInfo {}
        set_connection_parameter_value bpf_clock_bridge.out_clk/bpf_soc_apf_slv.clock clockResetSysInfo {}
        set_connection_parameter_value bpf_clock_bridge.out_clk/bpf_soc_apf_slv.clock resetDomainSysInfo {-1}
        add_connection bpf_reset_bridge.out_reset/bpf_soc_apf_slv.reset
        set_connection_parameter_value bpf_reset_bridge.out_reset/bpf_soc_apf_slv.reset clockDomainSysInfo {-1}
        set_connection_parameter_value bpf_reset_bridge.out_reset/bpf_soc_apf_slv.reset clockResetSysInfo {}
        set_connection_parameter_value bpf_reset_bridge.out_reset/bpf_soc_apf_slv.reset resetDomainSysInfo {-1}
        add_connection bpf_clock_bridge.out_clk/bpf_soc_pcie_slv.clock
        set_connection_parameter_value bpf_clock_bridge.out_clk/bpf_soc_pcie_slv.clock clockDomainSysInfo {-1}
        set_connection_parameter_value bpf_clock_bridge.out_clk/bpf_soc_pcie_slv.clock clockRateSysInfo {}
        set_connection_parameter_value bpf_clock_bridge.out_clk/bpf_soc_pcie_slv.clock clockResetSysInfo {}
        set_connection_parameter_value bpf_clock_bridge.out_clk/bpf_soc_pcie_slv.clock resetDomainSysInfo {-1}
        add_connection bpf_reset_bridge.out_reset/bpf_soc_pcie_slv.reset
        set_connection_parameter_value bpf_reset_bridge.out_reset/bpf_soc_pcie_slv.reset clockDomainSysInfo {-1}
        set_connection_parameter_value bpf_reset_bridge.out_reset/bpf_soc_pcie_slv.reset clockResetSysInfo {}
        set_connection_parameter_value bpf_reset_bridge.out_reset/bpf_soc_pcie_slv.reset resetDomainSysInfo {-1}
        ...
        add_connection bpf_clock_bridge.out_clk/bpf_host_apf_slv.clock
        set_connection_parameter_value bpf_clock_bridge.out_clk/bpf_host_apf_slv.clock clockDomainSysInfo {-1}
        set_connection_parameter_value bpf_clock_bridge.out_clk/bpf_host_apf_slv.clock clockRateSysInfo {}
        set_connection_parameter_value bpf_clock_bridge.out_clk/bpf_host_apf_slv.clock clockResetSysInfo {}
        set_connection_parameter_value bpf_clock_bridge.out_clk/bpf_host_apf_slv.clock resetDomainSysInfo {-1}
        add_connection bpf_reset_bridge.out_reset/bpf_host_apf_slv.reset
        set_connection_parameter_value bpf_reset_bridge.out_reset/bpf_host_apf_slv.reset clockDomainSysInfo {-1}
        set_connection_parameter_value bpf_reset_bridge.out_reset/bpf_host_apf_slv.reset clockResetSysInfo {}
        set_connection_parameter_value bpf_reset_bridge.out_reset/bpf_host_apf_slv.reset resetDomainSysInfo {-1}
	...
	set_connection_parameter_value bpf_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave slaveDataWidthSysInfo {-1}
        ...
        add_connection bpf_apf_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave
        set_connection_parameter_value bpf_apf_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave addressMapSysInfo {}
        set_connection_parameter_value bpf_apf_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave addressWidthSysInfo {}
        set_connection_parameter_value bpf_apf_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave arbitrationPriority {1}
        set_connection_parameter_value bpf_apf_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave baseAddress {0x10000}
        set_connection_parameter_value bpf_apf_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave defaultConnection {0}
        set_connection_parameter_value bpf_apf_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave domainAlias {}
        set_connection_parameter_value bpf_apf_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
        set_connection_parameter_value bpf_apf_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave qsys_mm.clockCrossingAdapter {HANDSHAKE}
        set_connection_parameter_value bpf_apf_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave qsys_mm.enableEccProtection {FALSE}
        set_connection_parameter_value bpf_apf_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave qsys_mm.enableInstrumentation {FALSE}
        set_connection_parameter_value bpf_apf_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave qsys_mm.insertDefaultSlave {FALSE}
        set_connection_parameter_value bpf_apf_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave qsys_mm.interconnectResetSource {DEFAULT}
        set_connection_parameter_value bpf_apf_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave qsys_mm.interconnectType {STANDARD}
        set_connection_parameter_value bpf_apf_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave qsys_mm.maxAdditionalLatency {1}
        set_connection_parameter_value bpf_apf_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave qsys_mm.syncResets {FALSE}
        set_connection_parameter_value bpf_apf_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
        set_connection_parameter_value bpf_apf_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave slaveDataWidthSysInfo {-1}
        ...
        set_connection_parameter_value bpf_apf_mst.altera_axi4lite_master/bpf_pmci_slv.altera_axi4lite_slave baseAddress {0x80000}
        ...
        add_connection bpf_clock_bridge.out_clk/bpf_host_apf_mst.clock
        set_connection_parameter_value bpf_clock_bridge.out_clk/bpf_host_apf_mst.clock clockDomainSysInfo {-1}
        set_connection_parameter_value bpf_clock_bridge.out_clk/bpf_host_apf_mst.clock clockRateSysInfo {}
        set_connection_parameter_value bpf_clock_bridge.out_clk/bpf_host_apf_mst.clock clockResetSysInfo {}
        set_connection_parameter_value bpf_clock_bridge.out_clk/bpf_host_apf_mst.clock resetDomainSysInfo {-1}
        add_connection bpf_reset_bridge.out_reset/bpf_host_apf_mst.reset
        set_connection_parameter_value bpf_reset_bridge.out_reset/bpf_host_apf_mst.reset clockDomainSysInfo {-1}
        set_connection_parameter_value bpf_reset_bridge.out_reset/bpf_host_apf_mst.reset clockResetSysInfo {}
        set_connection_parameter_value bpf_reset_bridge.out_reset/bpf_host_apf_mst.reset resetDomainSysInfo {-1}
	add_connection bpf_host_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave
	set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave addressMapSysInfo {}
	set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave addressWidthSysInfo {}
	set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave arbitrationPriority {1}
	set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave baseAddress {0x0000}
	set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave defaultConnection {1}
	set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave domainAlias {}
	set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave qsys_mm.clockCrossingAdapter {HANDSHAKE}
	set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave qsys_mm.enableAllPipelines {FALSE}
	set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave qsys_mm.enableEccProtection {FALSE}
	set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave qsys_mm.enableInstrumentation {FALSE}
	set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave qsys_mm.insertDefaultSlave {FALSE}
	set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave qsys_mm.interconnectResetSource {DEFAULT}
	set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave qsys_mm.interconnectType {STANDARD}
	set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave qsys_mm.maxAdditionalLatency {1}
	set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave qsys_mm.optimizeRdFifoSize {FALSE}
	set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave qsys_mm.piplineType {PIPELINE_STAGE}
	set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave qsys_mm.responseFifoType {REGISTER_BASED}
	set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave qsys_mm.syncResets {FALSE}
	set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave slaveDataWidthSysInfo {-1}
        add_connection bpf_host_apf_mst.altera_axi4lite_master/bpf_pcie_slv.altera_axi4lite_slave
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pcie_slv.altera_axi4lite_slave addressMapSysInfo {}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pcie_slv.altera_axi4lite_slave addressWidthSysInfo {}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pcie_slv.altera_axi4lite_slave arbitrationPriority {1}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pcie_slv.altera_axi4lite_slave baseAddress {0x00000}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pcie_slv.altera_axi4lite_slave defaultConnection {0}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pcie_slv.altera_axi4lite_slave domainAlias {}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pcie_slv.altera_axi4lite_slave qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pcie_slv.altera_axi4lite_slave qsys_mm.clockCrossingAdapter {HANDSHAKE}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pcie_slv.altera_axi4lite_slave qsys_mm.enableEccProtection {FALSE}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pcie_slv.altera_axi4lite_slave qsys_mm.enableInstrumentation {FALSE}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pcie_slv.altera_axi4lite_slave qsys_mm.insertDefaultSlave {FALSE}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pcie_slv.altera_axi4lite_slave qsys_mm.interconnectResetSource {DEFAULT}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pcie_slv.altera_axi4lite_slave qsys_mm.interconnectType {STANDARD}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pcie_slv.altera_axi4lite_slave qsys_mm.maxAdditionalLatency {1}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pcie_slv.altera_axi4lite_slave qsys_mm.syncResets {FALSE}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pcie_slv.altera_axi4lite_slave qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pcie_slv.altera_axi4lite_slave slaveDataWidthSysInfo {-1}
        
        add_connection bpf_host_apf_mst.altera_axi4lite_master/bpf_pmci_slv.altera_axi4lite_slave
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pmci_slv.altera_axi4lite_slave addressMapSysInfo {}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pmci_slv.altera_axi4lite_slave addressWidthSysInfo {}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pmci_slv.altera_axi4lite_slave arbitrationPriority {1}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pmci_slv.altera_axi4lite_slave baseAddress {0x80000}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pmci_slv.altera_axi4lite_slave defaultConnection {0}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pmci_slv.altera_axi4lite_slave domainAlias {}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pmci_slv.altera_axi4lite_slave qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pmci_slv.altera_axi4lite_slave qsys_mm.clockCrossingAdapter {HANDSHAKE}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pmci_slv.altera_axi4lite_slave qsys_mm.enableEccProtection {FALSE}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pmci_slv.altera_axi4lite_slave qsys_mm.enableInstrumentation {FALSE}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pmci_slv.altera_axi4lite_slave qsys_mm.insertDefaultSlave {FALSE}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pmci_slv.altera_axi4lite_slave qsys_mm.interconnectResetSource {DEFAULT}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pmci_slv.altera_axi4lite_slave qsys_mm.interconnectType {STANDARD}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pmci_slv.altera_axi4lite_slave qsys_mm.maxAdditionalLatency {1}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pmci_slv.altera_axi4lite_slave qsys_mm.syncResets {FALSE}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pmci_slv.altera_axi4lite_slave qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
        set_connection_parameter_value bpf_host_apf_mst.altera_axi4lite_master/bpf_pmci_slv.altera_axi4lite_slave slaveDataWidthSysInfo {-1}
	...
	set_connection_parameter_value bpf_fme_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave slaveDataWidthSysInfo {-1}
        add_connection bpf_fme_mst.altera_axi4lite_master/bpf_soc_apf_slv.altera_axi4lite_slave
        set_connection_parameter_value bpf_fme_mst.altera_axi4lite_master/bpf_soc_apf_slv.altera_axi4lite_slave addressMapSysInfo {}
        set_connection_parameter_value bpf_fme_mst.altera_axi4lite_master/bpf_soc_apf_slv.altera_axi4lite_slave addressWidthSysInfo {}
        set_connection_parameter_value bpf_fme_mst.altera_axi4lite_master/bpf_soc_apf_slv.altera_axi4lite_slave arbitrationPriority {1}
        set_connection_parameter_value bpf_fme_mst.altera_axi4lite_master/bpf_soc_apf_slv.altera_axi4lite_slave baseAddress {0x00000}
        set_connection_parameter_value bpf_fme_mst.altera_axi4lite_master/bpf_soc_apf_slv.altera_axi4lite_slave defaultConnection {0}
        set_connection_parameter_value bpf_fme_mst.altera_axi4lite_master/bpf_soc_apf_slv.altera_axi4lite_slave domainAlias {}
        set_connection_parameter_value bpf_fme_mst.altera_axi4lite_master/bpf_soc_apf_slv.altera_axi4lite_slave qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
        set_connection_parameter_value bpf_fme_mst.altera_axi4lite_master/bpf_soc_apf_slv.altera_axi4lite_slave qsys_mm.clockCrossingAdapter {HANDSHAKE}
        set_connection_parameter_value bpf_fme_mst.altera_axi4lite_master/bpf_soc_apf_slv.altera_axi4lite_slave qsys_mm.enableEccProtection {FALSE}
        set_connection_parameter_value bpf_fme_mst.altera_axi4lite_master/bpf_soc_apf_slv.altera_axi4lite_slave qsys_mm.enableInstrumentation {FALSE}
        set_connection_parameter_value bpf_fme_mst.altera_axi4lite_master/bpf_soc_apf_slv.altera_axi4lite_slave qsys_mm.insertDefaultSlave {FALSE}
        set_connection_parameter_value bpf_fme_mst.altera_axi4lite_master/bpf_soc_apf_slv.altera_axi4lite_slave qsys_mm.interconnectResetSource {DEFAULT}
        set_connection_parameter_value bpf_fme_mst.altera_axi4lite_master/bpf_soc_apf_slv.altera_axi4lite_slave qsys_mm.interconnectType {STANDARD}
        set_connection_parameter_value bpf_fme_mst.altera_axi4lite_master/bpf_soc_apf_slv.altera_axi4lite_slave qsys_mm.maxAdditionalLatency {1}
        set_connection_parameter_value bpf_fme_mst.altera_axi4lite_master/bpf_soc_apf_slv.altera_axi4lite_slave qsys_mm.syncResets {FALSE}
        set_connection_parameter_value bpf_fme_mst.altera_axi4lite_master/bpf_soc_apf_slv.altera_axi4lite_slave qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
        set_connection_parameter_value bpf_fme_mst.altera_axi4lite_master/bpf_soc_apf_slv.altera_axi4lite_slave slaveDataWidthSysInfo {-1}
	...
	set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_default_slv.altera_axi4lite_slave slaveDataWidthSysInfo {-1}
        add_connection bpf_pmci_mst.altera_axi4lite_master/bpf_host_apf_slv.altera_axi4lite_slave
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_host_apf_slv.altera_axi4lite_slave addressMapSysInfo {}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_host_apf_slv.altera_axi4lite_slave addressWidthSysInfo {}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_host_apf_slv.altera_axi4lite_slave arbitrationPriority {1}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_host_apf_slv.altera_axi4lite_slave baseAddress {0x200000}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_host_apf_slv.altera_axi4lite_slave defaultConnection {0}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_host_apf_slv.altera_axi4lite_slave domainAlias {}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_host_apf_slv.altera_axi4lite_slave qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_host_apf_slv.altera_axi4lite_slave qsys_mm.clockCrossingAdapter {HANDSHAKE}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_host_apf_slv.altera_axi4lite_slave qsys_mm.enableEccProtection {FALSE}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_host_apf_slv.altera_axi4lite_slave qsys_mm.enableInstrumentation {FALSE}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_host_apf_slv.altera_axi4lite_slave qsys_mm.insertDefaultSlave {FALSE}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_host_apf_slv.altera_axi4lite_slave qsys_mm.interconnectResetSource {DEFAULT}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_host_apf_slv.altera_axi4lite_slave qsys_mm.interconnectType {STANDARD}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_host_apf_slv.altera_axi4lite_slave qsys_mm.maxAdditionalLatency {1}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_host_apf_slv.altera_axi4lite_slave qsys_mm.syncResets {FALSE}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_host_apf_slv.altera_axi4lite_slave qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_host_apf_slv.altera_axi4lite_slave slaveDataWidthSysInfo {-1}
        ...
        add_connection bpf_pmci_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave addressMapSysInfo {}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave addressWidthSysInfo {}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave arbitrationPriority {1}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave baseAddress {0x10000}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave defaultConnection {0}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave domainAlias {}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave qsys_mm.clockCrossingAdapter {HANDSHAKE}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave qsys_mm.enableEccProtection {FALSE}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave qsys_mm.enableInstrumentation {FALSE}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave qsys_mm.insertDefaultSlave {FALSE}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave qsys_mm.interconnectResetSource {DEFAULT}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave qsys_mm.interconnectType {STANDARD}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave qsys_mm.maxAdditionalLatency {1}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave qsys_mm.syncResets {FALSE}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
        set_connection_parameter_value bpf_pmci_mst.altera_axi4lite_master/bpf_soc_pcie_slv.altera_axi4lite_slave slaveDataWidthSysInfo {-1}
	...
	set_interface_property bpf_host_apf_mst EXPORT_OF bpf_host_apf_mst.altera_axi4lite_slave
	...
	set_interface_property bpf_soc_apf_slv EXPORT_OF bpf_soc_apf_slv.altera_axi4lite_master
	set_interface_property bpf_soc_pcie_slv EXPORT_OF bpf_soc_pcie_slv.altera_axi4lite_master
	...
	set_interface_property bpf_host_apf_slv EXPORT_OF bpf_host_apf_slv.altera_axi4lite_master
