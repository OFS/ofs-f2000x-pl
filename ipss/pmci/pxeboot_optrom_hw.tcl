...
set_parameter_property HOST_RDADDR_WIDTH ALLOWED_RANGES { \
   ...
   "17:17  -  128KBytes Address Range for OptionROM" \
   "18:18  -  256KBytes Address Range for OptionROM" \
}
...
set_parameter_property OPTROM_SIZE ALLOWED_RANGES { \
   ...
   "128:128KBytes of OptionROM" \
   "256:256KBytes of OptionROM" \
}
...
proc ip_elaborate { } {
   ...
   set_port_property avmm_mstr_addr width_expr [expr {$fadr_width + 1}]
}