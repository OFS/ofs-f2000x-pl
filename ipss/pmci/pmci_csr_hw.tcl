...
set_parameter_property STAGING_AREA_BADDR GROUP "Flash Burst Master Properties"
...
add_parameter SS_ADDR_WIDTH INTEGER 24 "Address width of IOFS sub systems. PMCI uses this as address width of its AXI master interface. This parameter restricts the IOFS address range PMCI can access."
...
set_parameter_property PCIE_SS_ADDR ALLOWED_RANGES {0x0:0xFFFFFF}
...
set_parameter_property HSSI_SS_ADDR ALLOWED_RANGES {0x0:0xFFFFFF}
...
set_parameter_property PCIEVDM_AFU_ADDR ALLOWED_RANGES {0x0:0xFFFFFF}
...
set_parameter_property QSFPA_CTRL_ADDR ALLOWED_RANGES {0x0:0xFFFFFF}
...
set_parameter_property QSFPB_CTRL_ADDR ALLOWED_RANGES {0x0:0xFFFFFF}
...
set_parameter_property QSPI_BAUDRATE ALLOWED_RANGES { \
   ...
   "5:Flash baudrate is 1/10 of PMCI core clock" \
}
...
add_parameter PMCI_DFH_END_OF_LIST INTEGER 0 "PMCI's DFH End of List"
set_parameter_property PMCI_DFH_END_OF_LIST DISPLAY_NAME "DFH End of List"
set_parameter_property PMCI_DFH_END_OF_LIST GROUP "PMCI DFH Paramters"
set_parameter_property PMCI_DFH_END_OF_LIST UNITS None
set_parameter_property PMCI_DFH_END_OF_LIST HDL_PARAMETER true
set_parameter_property PMCI_DFH_END_OF_LIST AFFECTS_ELABORATION true
set_parameter_property PMCI_DFH_END_OF_LIST AFFECTS_GENERATION false
set_parameter_property PMCI_DFH_END_OF_LIST ENABLED true
set_parameter_property PMCI_DFH_END_OF_LIST ALLOWED_RANGES { \
   "0:0(PMCI is NOT the end of DFH list)" \
   "1:1(PMCI is the end of DFH list)" \
}

add_parameter PMCI_DFH_NEXT_DFH_OFFSET INTEGER 0x20000 "Next DFH Offset"
set_parameter_property PMCI_DFH_NEXT_DFH_OFFSET DISPLAY_NAME "Next DFH Offset"
set_parameter_property PMCI_DFH_NEXT_DFH_OFFSET GROUP "PMCI DFH Paramters"
set_parameter_property PMCI_DFH_NEXT_DFH_OFFSET UNITS None
set_parameter_property PMCI_DFH_NEXT_DFH_OFFSET HDL_PARAMETER true
set_parameter_property PMCI_DFH_NEXT_DFH_OFFSET AFFECTS_ELABORATION true
set_parameter_property PMCI_DFH_NEXT_DFH_OFFSET AFFECTS_GENERATION false
set_parameter_property PMCI_DFH_NEXT_DFH_OFFSET ENABLED true
set_parameter_property PMCI_DFH_NEXT_DFH_OFFSET ALLOWED_RANGES {0x0:0xFFFFFF}
set_parameter_property PMCI_DFH_NEXT_DFH_OFFSET DISPLAY_HINT hexadecimal

add_parameter PMCI_DFH_FEAT_VER INTEGER 0x1 "PMCI's DFH Feature Revision"
set_parameter_property PMCI_DFH_FEAT_VER DISPLAY_NAME "DFH Feature Revision"
set_parameter_property PMCI_DFH_FEAT_VER GROUP "PMCI DFH Paramters"
set_parameter_property PMCI_DFH_FEAT_VER UNITS None
set_parameter_property PMCI_DFH_FEAT_VER HDL_PARAMETER true
set_parameter_property PMCI_DFH_FEAT_VER AFFECTS_ELABORATION true
set_parameter_property PMCI_DFH_FEAT_VER AFFECTS_GENERATION false
set_parameter_property PMCI_DFH_FEAT_VER ENABLED true
set_parameter_property PMCI_DFH_FEAT_VER ALLOWED_RANGES {0x0:0xF}

add_parameter PMCI_DFH_FEAT_ID INTEGER 0x12 "PMCI's DFH Feature ID"
set_parameter_property PMCI_DFH_FEAT_ID DISPLAY_NAME "DFH Feature ID"
set_parameter_property PMCI_DFH_FEAT_ID GROUP "PMCI DFH Paramters"
set_parameter_property PMCI_DFH_FEAT_ID UNITS None
set_parameter_property PMCI_DFH_FEAT_ID HDL_PARAMETER true
set_parameter_property PMCI_DFH_FEAT_ID AFFECTS_ELABORATION true
set_parameter_property PMCI_DFH_FEAT_ID AFFECTS_GENERATION false
set_parameter_property PMCI_DFH_FEAT_ID ENABLED true
set_parameter_property PMCI_DFH_FEAT_ID ALLOWED_RANGES {0x0:0xFFF}
set_parameter_property PMCI_DFH_FEAT_ID DISPLAY_HINT hexadecimal
...
add_interface_port pnios_avmm_slv pnios_avmm_slv_addr address Input 6
...
add_interface_port fbm_if stgng_area_baddr stgng_area_baddr Output -1
...
add_interface_port mpc_if pcie_vdm_pulse_1us pulse_1us Output 1
...
add_interface_port orom_if pxeboot_pulse_1us pulse_1us Output 1
...
#  elseif {$sa_baddr < [expr {($addr_span * 2) / 4}]} {
...
proc ip_elaborate { } {
   ...
   set_port_property stgng_area_baddr width_expr $fadr_width
