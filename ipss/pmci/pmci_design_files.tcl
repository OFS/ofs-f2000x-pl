...
set_global_assignment -name IP_FILE                  $::env(BUILD_ROOT_REL)/ipss/pmci/ip/pmci_ss/pmci_ss_eth_tse_0.ip
set_global_assignment -name IP_FILE                  $::env(BUILD_ROOT_REL)/ipss/pmci/ip/pmci_ss/pmci_ss_fpga_mii2rmii_0.ip 
