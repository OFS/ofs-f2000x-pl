...
# Parameters
# -----------------------------------------------------------------------------
add_parameter BMC_MCTP_BASE_ADDR INTEGER 0x00010000 "Base address of the BMC's MCTP over PCIe VDM Buffer."
set_parameter_property BMC_MCTP_BASE_ADDR DISPLAY_NAME "Base Address of BMC's MCTP over PCIe VDM Buffer"
#set_parameter_property BMC_MCTP_BASE_ADDR GROUP ""
set_parameter_property BMC_MCTP_BASE_ADDR UNITS None
set_parameter_property BMC_MCTP_BASE_ADDR HDL_PARAMETER true
set_parameter_property BMC_MCTP_BASE_ADDR AFFECTS_ELABORATION true
set_parameter_property BMC_MCTP_BASE_ADDR AFFECTS_GENERATION false
set_parameter_property BMC_MCTP_BASE_ADDR ENABLED true
set_parameter_property BMC_MCTP_BASE_ADDR DISPLAY_HINT hexadecimal

add_parameter INGR_MSTR_ADDR_WIDTH INTEGER 20 "Address width of the ingress master AvMM interface"
...
set_parameter_property INGR_MSTR_ADDR_WIDTH ALLOWED_RANGES {3:32}
...
add_parameter SS_ADDR_WIDTH INTEGER 24 "Address width of IOFS FIM sub systems. This will also be used as address width of the egress master AvMM interface"
...
add_parameter MCTP_EP_DISCOVER_EN INTEGER 1 "Enable initiating MCTP endpoint disovery when out of reset"
set_parameter_property MCTP_EP_DISCOVER_EN DISPLAY_NAME "MCTP Endpoint Discovery Notify Request Enable"
# set_parameter_property MCTP_EP_DISCOVER_EN GROUP ""
set_parameter_property MCTP_EP_DISCOVER_EN UNITS None
set_parameter_property MCTP_EP_DISCOVER_EN HDL_PARAMETER true
set_parameter_property MCTP_EP_DISCOVER_EN AFFECTS_ELABORATION true
set_parameter_property MCTP_EP_DISCOVER_EN AFFECTS_GENERATION false
set_parameter_property MCTP_EP_DISCOVER_EN ENABLED true
set_parameter_property MCTP_EP_DISCOVER_EN ALLOWED_RANGES { \
   "0:Don't send MCTP endpoint discovery notify reques" \
   "1:Implement MCTP endpoint discovery notify request" \
}
...
add_interface_port csr_if pulse_1us pulse_1us Input 1
...
proc ip_validate { } {
   ...
   set bmc_mctp_baddr [ get_parameter_value BMC_MCTP_BASE_ADDR ]
...
#  set egrsm_awidth [ get_parameter_value SS_ADDR_WIDTH ]
   ...
   if { [expr {$bmc_mctp_baddr & 0xFFF}] != 0 } {
      send_message Error "BMC MCTP Base Address should be 4KBytes aligned"
   }
}
