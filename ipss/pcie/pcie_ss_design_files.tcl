...
set_global_assignment -name IP_FILE $::env(BUILD_ROOT_REL)/ipss/pcie/qip/soc_pcie_ss.ip
...
dict set ::ofs_ip_cfg_db::ip_db $::env(BUILD_ROOT_REL)/ipss/pcie/qip/soc_pcie_ss.ip [list soc_pcie_ss pcie_ss_get_cfg.tcl]
