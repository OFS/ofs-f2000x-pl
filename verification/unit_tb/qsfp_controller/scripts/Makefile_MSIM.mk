...
ifdef COV
    ...
    ##VLOG_OPT += +define+ENABLE_SOC_HOST_COVERAGE -cm line+cond+fsm+tgl+branch -cm_dir simv.vdb
    VLOG_OPT += +define+ENABLE_SOC_HOST_COVERAGE 
    ...
    #SIMV_OPT += +define+ENABLE_SOC_HOST_COVERAGE -cm line+cond+fsm+tgl+branch -cm_name $(TESTNAME) -cm_test qsfp 
...
setup: clean_dve
	...
	#rsync -avz --checksum --ignore-times ../../../../ip_libraries/* $(VERDIR)/unit_tb/qsfp_controller/sim/
	@echo ''
	...
	cd $(OFS_ROOTDIR)/ofs-common/scripts/common && "$(OFS_ROOTDIR)"/ofs-common/scripts/common/sim/gen_sim_files.sh fm89 #Default
...
vopt_adp:
	vopt $(TOP_LEVEL_NAME) -o des -designfile design_2.bin -debug $(VLOG_OPT) -suppress 19,2732,12003,7033,3837,8386,13364,2388,13311,8364,7061,7033,7077 +initwire+0 -f msim_lib.f  -L $(QUESTA_HOME)/uvm-1.2 -work $(QSFP_SCRIPTS_DIR)/../sim/work -l msim_vopt.log 
