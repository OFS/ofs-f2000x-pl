...
vopt_adp:
	vopt $(TOP_LEVEL_NAME) -o des -designfile design_2.bin -debug $(VLOG_OPT) -suppress 19,2732,12003,7033,3837,8386,13364,2388,13311,8364,7061,7033,7077 +initwire+0 -L $(QUESTA_HOME)/uvm-1.2 -work $(QSFP_SCRIPTS_DIR)/../sim/work -l msim_vopt.log 
