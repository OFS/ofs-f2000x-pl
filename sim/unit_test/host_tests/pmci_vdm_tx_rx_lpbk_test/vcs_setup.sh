...
cp -rf $OFS_ROOTDIR/sim/unit_test/host_tests/pmci_vdm_tx_rx_lpbk_test/cm_hier.file $OFS_ROOTDIR/sim/unit_test/host_tests/pmci_vdm_tx_rx_lpbk_test/sim_vcs
