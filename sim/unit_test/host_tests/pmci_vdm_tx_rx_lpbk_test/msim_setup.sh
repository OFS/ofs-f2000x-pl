...
if [ $SKIP_SIM -eq 0 ]; then
  ...
  vsim -c top_tb -suppress 7033,12023,3053,2732 -voptargs="-access=rw+/. -designfile design_2.bin -debug +initreg+0 +initwire+0" -qwavedb=+signal -do "add log -r /* ; run -all; quit -f"
