...
cp -rf $OFS_ROOTDIR/sim/unit_test/host_tests/pmci_vdm_tx_rx_all_toggle_test/cm_hier.file $OFS_ROOTDIR/sim/unit_test/host_tests/pmci_vdm_tx_rx_all_toggle_test/sim_vcs
