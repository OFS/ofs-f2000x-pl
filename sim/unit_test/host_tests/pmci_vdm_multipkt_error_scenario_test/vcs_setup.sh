...
cp -rf $OFS_ROOTDIR/sim/unit_test/host_tests/pmci_vdm_multipkt_error_scenario_test/cm_hier.file $OFS_ROOTDIR/sim/unit_test/host_tests/pmci_vdm_multipkt_error_scenario_test/sim_vcs
